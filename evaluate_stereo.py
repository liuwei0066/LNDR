...
def validate_kitti(model, iters=32, mixed_prec=False):
    ...
    for val_id in range(len(val_dataset)):
        _, image1, image2, flow_gt, valid_gt = val_dataset[val_id]
        # image1 = load_image("/home/indemind/datasets/depth_estimate/madnet_test_data/KITTI_with_disp/paddingmap/left/000000_10.png")
        # image2 = load_image("/home/indemind/datasets/depth_estimate/madnet_test_data/KITTI_with_disp/paddingmap/right/000000_10.png")
        image1 = image1[None].cuda()
        image2 = image2[None].cuda()
